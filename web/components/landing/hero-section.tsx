...
export function HeroSection() {
    ...
    return (
        <section ref={heroRef} className="min-h-[calc(100vh-4rem)] flex flex-col items-center justify-center py-20 px-6 max-w-7xl mx-auto text-center space-y-8">
            ...
            <h1 className="text-5xl md:text-7xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 dark:from-white dark:via-white/90 dark:to-white/50 pb-2">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                <Link href="/studio">
                    <Button size="lg" className="h-12 px-8 text-base shadow-lg shadow-indigo-500/20">
                        Start Creating Free
                        <ArrowRight className="ml-2 w-4 h-4" />
                    </Button>
                </Link>
                <Link href="#demo">
                    <Button variant="outline" size="lg" className="h-12 px-8 text-base border-border/40 hover:bg-secondary/50">
                        Listen to Samples
